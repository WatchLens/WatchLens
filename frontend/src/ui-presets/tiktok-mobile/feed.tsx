/**
 * TikTok mobile feed — 2-column 9:16 grid with thumbnail-overlaid play
 * count + "time ago" badges, and a tight avatar / handle / like row
 * below each card. Mirrors TikTok's mobile web "Discover" layout.
 *
 * Decorative elements that TikTok shows but the platform doesn't model
 * are intentionally omitted: top brand bar, search input, bottom 5-tab
 * nav, follow button. The remaining UX is recommendation grid + click
 * to /watch/:id, which is the core feed contract.
 */
...
function MobileCard({ video }: { video: Video }): JSX.Element {
  ...
  return (
    <article className="cursor-pointer">
      ...
      {/* Avatar + handle + like row (under card) */}
...
export default function TiktokMobileFeed(): JSX.Element {
    ...
    <FeedSurface videos={videos}>
      <div className="min-h-screen bg-white">
        ...
        <main className="pt-16 px-3 pb-3">
          <h1 className="text-lg font-bold text-gray-900 mb-3">Recommended</h1>
